...
export const SectionTop: FC = () => {
	return (
		<section className="flex min-h-screen items-center justify-center">
			<Header />
			<h1 className="relative text-center text-4xl font-bold text-zinc-700 lg:text-6xl">
				Ideias e Soluções em
				<span className="relative inline-block h-16 w-full overflow-hidden align-bottom">
